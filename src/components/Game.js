...
return (
	...
	<div className="mx-auto mt-8">
		...
		<h1 className="text-4xl text-orange-400 font-bold underline text-center">
		FIFTEEN PUZZLE GAME
		</h1>
		...
		<button
			onClick={newGame}
			className="text-indigo-900 font-bold block bg-gray-900 p-2 rounded w-full h-full bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% hover:opacity-90"
		>
			New Game
		</button>
		</div>
